...
//1. Инкапсуляция - метод оборачивания кода в класс для изолированной работы с ним и регулировки выборочного доступа к коду или реализованному функционалу для сторонних разработчиков.
//2. Объекты позволяют сделать код более аккуратным, упростить работу с кодом для разработчиков и также упросить возможность расширения кода. Из недостатков, наверное, изначальная реализация может оказаться сложнее и в больших проектах может быть сложная иерархия.
